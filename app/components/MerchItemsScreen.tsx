            ...
            <div className="grid grid-cols-2 gap-6 max-w-5xl mx-auto">
              {filteredItems.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div className="relative p-4 flex items-center justify-center" style={{ height: "452px" }}>
                      {item.image ? (
                        <img
                          src={item.image}
                          alt={item.name}
                    ...
                    <div className="p-3 bg-white flex flex-col justify-between gap-1" style={{ height: "144px" }}>
                      <p
                        className="text-xl font-black text-black text-center leading-tight overflow-hidden"
